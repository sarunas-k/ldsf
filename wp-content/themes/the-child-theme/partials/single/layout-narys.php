	...
	<div class="row">
		...
		<?php do_action( 'ocean_before_single_post_title' ); ?>
			...
			<header class="entry-header clr">
				<<?php echo esc_attr( $heading ); ?> class="single-post-title entry-title"<?php oceanwp_schema_markup( 'headline' ); ?>>
					<?php 
					if ($asmuo) {
			...
			if ( 'content' === $element ) {
				...
				do_action( 'ocean_before_single_post_content' ); ?>
					...
					<div class="entry-content clr"<?php oceanwp_schema_markup( 'entry_content' ); ?>>
						...
						?>
						<?php if ($tel) { ?>
							<p><strong>Tel.: </strong><a href="tel:<?php echo $tel; ?>"><?php echo $tel; ?></a></p>
						<?php }  if ($elpastas) { ?>
							<p><strong>El.paštas: </strong><a href="mailto:<?php echo $elpastas; ?>"><?php echo $elpastas; ?></a></p>
						<?php }  if ($tel) { ?>
